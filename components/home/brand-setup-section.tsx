...
const items = [
  {
    id: 1,
    title: "Morning Puja",
    subtitle: "Diya, incense, mantra, and calm intention",
    image: "/spiritual-hero.png",
  },
  {
    id: 2,
    title: "Temple Corner",
    subtitle: "Saffron decor for a peaceful mandir space",
    image: "/spiritual-hero.png",
  },
  {
    id: 3,
    title: "Meditation Time",
    subtitle: "Mala, breath, and quiet devotional focus",
    image: "/spiritual-products.png",
  },
  {
    id: 4,
    title: "Festival Rituals",
    subtitle: "Aarti essentials for auspicious gatherings",
    image: "/spiritual-products.png",
  },
];
    ...
    <section className="overflow-hidden bg-[#fffaf3] pb-10 pt-4 text-[#431407] md:pb-16 md:pt-4">
      <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="md:hidden">
          <p className="mb-3 text-[11px] font-semibold uppercase tracking-[0.22em] text-orange-900/45">
            Swipe to explore
          </p>
